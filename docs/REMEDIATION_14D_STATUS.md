...
- Estado: completado
- Implementación:
  - `DashboardBusiness` dividido en tabs pesados lazy-loaded:
    - `DashboardBillingTab`
    - `DashboardAdsTab`
    - `DashboardVerificationTab`
  - Reducción del chunk del dashboard principal y menor trabajo de render al cambiar pestañas.
  - Archivos:
    - `apps/web/src/pages/DashboardBusiness.tsx`
    - `apps/web/src/components/dashboard-business/DashboardBillingTab.tsx`
    - `apps/web/src/components/dashboard-business/DashboardAdsTab.tsx`
    - `apps/web/src/components/dashboard-business/DashboardVerificationTab.tsx`
