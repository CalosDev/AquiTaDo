...
export class AnalyticsService {
    ...
    async getGrowthInsights(query: GrowthInsightsQueryDto) {
        ...
        const currentSignalSummary = buildGrowthSignalSummary(
            currentActivationEventRows,
            limit,
        );
        const previousSignalSummary = buildGrowthSignalSummary(
            previousActivationEventRows,
            limit,
        );
        const {
        ...
        const actionableAlerts = buildGrowthActionableAlerts(currentSignalSummary);
