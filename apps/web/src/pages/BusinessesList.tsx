                        ...
                        <>
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                                {sortedBusinesses.map((biz) => {
                                    ...
                                    const isFavorite = favoriteBusinessIds.has(biz.id);
                                    const isFavoriteProcessing = favoriteProcessingId === biz.id;
                                    const isPriorityImage = currentPage === 1 && currentView === 'list' && sortedBusinesses[0]?.id === biz.id;
                                    ...
                                    return (
                                        <BusinessCard
                                            ...
                                            isSelectedOnMap={isSelectedOnMap}
                                            locationLabel={locationLabel}
                                            onBusinessClick={(businessId) => {
                                                trackBusinessClick(businessId, 'businesses-list');
                                            }}
                                            onPrefetchBusiness={prefetchBusinessDestination}
                                            ...
                                            secondaryCategoryName={secondaryCategory ? formatPublicCategoryName(secondaryCategory.name) : null}
                                            trust={trust ?? null}
                                        />
                                    );
                                })}
