...
export function HomeDifferenceSection({ points }: HomeDifferenceSectionProps) {
    return (
        <section className="defer-render-section mx-auto max-w-7xl px-4 py-5 sm:px-6 lg:px-8 md:py-8">
            <div className="rounded-[1.75rem] border border-slate-200 bg-white/85 p-5 md:p-6">
                ...
                <div className="mt-5 grid grid-cols-1 gap-3 md:grid-cols-3">
                    {points.map((point) => (
                        <article key={point.title} className="rounded-2xl border border-slate-200 bg-slate-50/80 p-4">
