    ...
    return (
        <div className="discovery-callout">
            <div className="mb-4 flex flex-col gap-2 lg:flex-row lg:items-end lg:justify-between">
                <div>
                    <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-primary-600">Exploracion guiada</p>
                    <h2 className="mt-1 font-display text-2xl font-bold tracking-tight text-slate-900">
                        Encuentra opciones que si se sienten locales
                    </h2>
                    <p className="mt-1 max-w-2xl text-sm text-slate-600">
                        Ajusta provincia, vista y orden sin perder contexto. Todo esta pensado para comparar rapido y decidir mejor.
                    </p>
                </div>
