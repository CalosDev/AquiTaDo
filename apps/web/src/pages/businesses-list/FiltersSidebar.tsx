...
export function FiltersSidebar({
    ...
    return (
        <aside className={`${filtersOpen ? 'block' : 'hidden'} discovery-sidebar lg:block`}>
            <div id="filters-panel" className="card-filter density-medium space-y-5">
                <div className="flex items-start justify-between gap-3">
                    <div>
                        <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-500">Filtros avanzados</p>
                        <h2 className="mt-2 text-base font-semibold text-slate-900">Refina tu busqueda</h2>
