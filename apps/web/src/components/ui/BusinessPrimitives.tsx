...
export function PlanStatusCard({
    ...
    return (
        ...
        >
            ...
            <p className="mt-3 inline-flex flex-nowrap items-end gap-1 whitespace-nowrap text-slate-900">
                <span className="shrink-0 text-3xl font-bold leading-none">{price}</span>
                {priceSuffix ? (
                    <span className="shrink-0 text-base font-medium leading-none text-slate-500">
                        {priceSuffix}
                    </span>
                ) : null}
            </p>
